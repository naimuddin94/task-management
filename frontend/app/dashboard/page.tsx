...
import { Plus, Search, Calendar, Tag, AlertCircle, LogOut, Settings } from "lucide-react"
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            ...
            <Dialog open={isAddTaskOpen} onOpenChange={setIsAddTaskOpen}>
              ...
              <DialogContent className="max-w-md">
                ...
                <TaskForm categories={categories} onSubmit={addTask} onCancel={() => setIsAddTaskOpen(false)} />
              </DialogContent>
            </Dialog>
          </div>
        ...
        <div className="space-y-4">
          {filteredAndSortedTasks.length === 0 ? (
            ...
            filteredAndSortedTasks.map((task) => (
              <Card
                key={task.id}
                className={`cursor-pointer transition-all hover:shadow-md ${task.completed ? "opacity-75" : ""}`}
